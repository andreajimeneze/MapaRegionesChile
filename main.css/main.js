...
let Antofagasta = ["./assets/Antofagasta.jfif","A.ntofagasta","Uno de sus principales atractivos es el Portal de Antofagasta, arco de roca formado por la erosión del mar"];
...
let Ohiggins = ["./assets/Ohiggins.jpg","O Higgins","Sewell fue un pueblo minero construido en 1904 y fue declarado Patrimonio de la Humanidad por la Unesco en el 2006 debido a su valor histórico y cultural. Se encuentra enclavado en la cordillera de Los Andes a 60 kilómetros de Rancagua."];
