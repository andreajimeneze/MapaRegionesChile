...
let Araucania = ["/assets/Araucania.jpg","Araucanía","Uno de sus principales atractivos es el Portal de Antofagasta"];
let Rios = ["/assets/LosRios.jfif","LosRíos", "Uno de sus principales atractivos es el Portal de Antofagasta"];
...
tituloRegion.innerText = regiones[opcion][1];
...
function modificarContenido(opcion){
  ...
  // document.getElementById("img").src = "";
  // document.getElementById("region").innerHTML = contentEditable "";
  // document.getElementById("atractivos").innerHTML = "";
}
